...
def _dataset() -> list[BCStepRecord]:
    ...
    return [
        BCStepRecord(case=case, role_evidence=roles, placements={}, action=TypedAction(ActionPrimitive.PLACE_ABSOLUTE, block_index=0, x=0.0, y=0.0, w=2.0, h=3.0)),
        BCStepRecord(case=case, role_evidence=roles, placements={0: (0.0, 0.0, 2.0, 3.0)}, action=TypedAction(ActionPrimitive.PLACE_ABSOLUTE, block_index=1, x=2.0, y=0.0, w=3.0, h=2.0)),
    ]
